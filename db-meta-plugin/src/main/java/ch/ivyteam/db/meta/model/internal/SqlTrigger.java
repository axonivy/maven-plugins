...
public class SqlTrigger extends SqlTableContentDefinition {
   ...
   */
  public SqlTrigger(String triggerName, String tableName, List<SqlDmlStatement> stmtsForEachRow,
          List<SqlDmlStatement> stmtsForEachStatement, List<SqlDatabaseSystemHints> dbSysHints,
