...
public final class DbHints
{
  ...
  public final DbHint TRIGGER_EXECUTE_FOR_EACH_STATEMENT = new DbHint(SqlScriptGenerator.TRIGGER_EXECUTE_FOR_EACH_STATEMENT);
  ...
  public final DbHint CONVERT_EMPTY_STRING_TO_NULL = new DbHint(OracleSqlScriptGenerator.CONVERT_EMPTY_STRING_TO_NULL);
  ...
  public final class DbHint
  {
     ...
     * All database systems returned by {@link #databaseSystemName} are considered.
