...
final class MsSqlForeignKeys extends ForeignKeys {
  ...
  private void generateDropForeignKeyConstraintStoredProcedure(PrintWriter pr,
    ...
    if (!createdTemporaryStoredProcedures
            .contains(MsSqlServerSqlScriptGenerator.DROP_FOREIGN_CONSTRAINT_STORED_PROCUDRE)) {
      createdTemporaryStoredProcedures
              .add(MsSqlServerSqlScriptGenerator.DROP_FOREIGN_CONSTRAINT_STORED_PROCUDRE);
