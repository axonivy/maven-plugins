...
public class Identifiers
{
  ...
  public Identifiers(String quote, boolean upperCaseQuoted, List<String> additionalKeywords, List<String> nonKeywords)
  {
    this.quote = quote;
   ...
   */
  final void generateFullQualifiedColumnName(PrintWriter pr, SqlFullQualifiedColumnName fullQualifiedColumnName)
  {
