...
/**
 * Base class of all sql artefacts that can be specified inside an sql meta information
 * @author rwei
 */
  ...
  public SqlArtifact(List<SqlDatabaseSystemHints> dbSysHints, String comment) throws MetaException
  {
    ...
    if (dbSysHints != null)
    {
      for (SqlDatabaseSystemHints hints : dbSysHints)
      {
        ...
        {
          throw new MetaException("Hints for database system '"+hints.getDatabaseManagementSystem()+"' already defined");
        }
