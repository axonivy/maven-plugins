...
public class TestMetaOutputDifferenceGeneratorMojo {
  ...
  public void testUniqueConstraintIsAddedOracle() throws Exception {
    ...
    assertThat(sqlContent)
            .containsIgnoringCase(
                    "ALTER TABLE IWA_ExternalDatabaseProperty ADD UNIQUE (ExternalDatabaseId, PropertyName);");
  }
  ...
  @Test
  public void testRemoveOnDeleteReplaceByTrigger()
    ...
    assertThat(sqlContent)
            ...
            .contains(
                    "CALL IWA_Drop_ForeignKey_Constraint(SCHEMA(), 'IWA_LibrarySpecification', 'ResolvedLibraryId');");
  }
