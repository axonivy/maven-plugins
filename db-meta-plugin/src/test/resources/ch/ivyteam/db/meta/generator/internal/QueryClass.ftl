...
import ch.ivyteam.ivy.workflow.internal.query.${table.queryClassName}ExecutorProvider;
...
@Generated(value={"ch.ivyteam.db.meta.generator.internal.query.JavaQueryClassGenerator"}, date="${aDateTime}")
public class ${table.queryClassName} extends Query<${table.businessClassName}>
{
  ...
  /**
   * Creates a new query based on the given JSON. See {@link ${table.queryClassName}} for an example.
   * @param json the serialized ${table.queryClassName}, generated by {@link #asJson()} 
   * @return A new instance of ${table.queryClassName}
   */
  @PublicAPI(IvyScriptVisibility.EXPERT)
  public static ${table.queryClassName} fromJson(String json)
  {
    return Query.fromJson(json, create());
  }

  public static ${table.queryClassName} create(IQueryExecutor<${table.businessClassName}> executor)
  {
    ${table.queryClassName} query = new ${table.queryClassName}();
  ...
  public IFluentQueryExecutor<${table.businessClassName}> executor()
  {
    IQueryExecutor<${table.businessClassName}> exec = executor;
    if (exec == null)
    {
      exec = new ${table.queryClassName}ExecutorProvider().get();
      if (exec == null)
      {
        throw new IllegalStateException("query must be set up with the method create(IQueryExecutor<${table.businessClassName}> executor) in order to be executuable");
      }
    }
...
<#if column.isDeprecated()>
    ...
    <#elseif column.supportsClobOption()>
    public IClobColumnFilterQuery ${StringUtils.uncapitalize(column.name)}();
...
<#if column.isDeprecated()>
    ...
    public IClobColumnFilterQuery ${StringUtils.uncapitalize(column.name)}()
    {
      return new ClobColumnFilterQuery(this, ${column.javaColumnConstantName});
    }
    <#elseif column.isEnumeration()>
    public I${column.getEnumerationInfo().getSimpleName()}FilterQuery ${StringUtils.uncapitalize(column.name)}()
    {
...
<#if table.hasClobColumns || table.hasStringColumns>
  /**
   * Provides filter functionality for a clob column of {@link ${table.businessClassName}}
   */
  @PublicAPI(IvyScriptVisibility.EXPERT)
  @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
  ...
  {
    public ClobColumnFilterQuery(Query<${table.businessClassName}> parentQuery,  ColumnName column)
    {
      super(parentQuery, column);
    }
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IStringColumnFilterQuery#isLikeIgnoreCase(String)
     */
    @Override
    public FilterLink isLikeIgnoreCase(String value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IStringColumnFilterQuery#isNotLikeIgnoreCase(String)
     */
    @Override
    public FilterLink isNotLikeIgnoreCase(String value)
    {
...
<#if table.hasStringColumns>
  ...
  static class StringColumnFilterQuery extends ClobColumnFilterQuery implements IStringColumnFilterQuery
  {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IStringColumnFilterQuery#isEqualIgnoreCase(String)
     */
    @Override
    public FilterLink isEqualIgnoreCase(String value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IStringColumnFilterQuery#isNotEqualIgnoreCase(String)
     */
    @Override
    public FilterLink isNotEqualIgnoreCase(String value)
    {
...
<#if table.hasNumberColumns || table.hasIntegerColumns >
  /**
...
<#if table.hasIntegerColumns>
  ...
  public static class IntegerColumnFilterQuery extends ColumnFilterQuery implements IIntegerColumnFilterQuery
  {
    ...
    IntegerColumnFilterQuery(Query<${table.businessClassName}> parentQuery, ColumnName column)
    {
      super(parentQuery, column);
...
<#if table.hasDateColumns>
  ...
  public interface IDateColumnFilterQuery extends IColumnFilterQuery
  {
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isEqual(java.util.Date value);
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isNotEqual(java.util.Date value);
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isGreaterThan(java.util.Date value);
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isGreaterOrEqualThan(java.util.Date value);
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isLowerThan(java.util.Date value);
    ...
    @PublicAPI(IvyScriptVisibility.EXPERT)
    @Reviewed(date="17.1.2012", reviewers="bb,fs,rwei")
    public FilterLink isLowerOrEqualThan(java.util.Date value);
  }
  ...
  private static class DateColumnFilterQuery extends ColumnFilterQuery implements IDateColumnFilterQuery
  {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isEqual(java.util.Date)
     */
    @Override
    public FilterLink isEqual(java.util.Date value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isNotEqual(java.util.Date)
     */
    @Override
    public FilterLink isNotEqual(java.util.Date value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isGreaterThan(java.util.Date)
     */
    @Override
    public FilterLink isGreaterThan(java.util.Date value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isGreaterOrEqualThan(java.util.Date)
     */
    @Override
    public FilterLink isGreaterOrEqualThan(java.util.Date value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isLowerThan(java.util.Date)
     */
    @Override
    public FilterLink isLowerThan(java.util.Date value)
    {
    ...
    /**
     * @see ${packageName}.${table.queryClassName}.IDateColumnFilterQuery#isLowerOrEqualThan(java.util.Date)
     */
    @Override
    public FilterLink isLowerOrEqualThan(java.util.Date value)
    {
