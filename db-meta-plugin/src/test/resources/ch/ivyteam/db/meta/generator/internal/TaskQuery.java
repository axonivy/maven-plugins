 ...
 *
  ...
  public interface IFilterLink 
  {
     ...
     * If you want to evaluate <code>a and (b or c)</code>, then use {@link FilterLink#and(TaskQuery)}</p>
     ...
     * <p>Example:
     * <code><pre>TaskQuery.create().name().isEqual("Name").and(
     *  TaskQuery.create().description().isEqual("Desc").or().description().isEqual("Description")
     * );</pre></code>
